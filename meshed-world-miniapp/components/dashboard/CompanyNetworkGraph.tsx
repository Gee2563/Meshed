...
export function CompanyNetworkGraph({ nodes, edges, graphLabel: _graphLabel = "current" }: CompanyNetworkGraphProps) {
                                ...
                                <div className="flex items-start gap-3">
                                  ...
                                  >
                                    ...
                                    <div className="min-w-0 flex-1">
                                      ...
                                      <p className="mt-1 text-[11px] uppercase tracking-[0.12em] text-slate">
                                        {person.suggestedRole ? titleCase(person.suggestedRole) : "Employee"}
