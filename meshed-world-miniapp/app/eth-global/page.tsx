        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">
                Built for VC firms and live investor communities&mdash;connecting communities in more productive ways.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div className="bg-white p-5 rounded-lg border border-orange-200 mb-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                        ...
                        <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-4 rounded-lg">
                          <p className="text-sm font-bold text-gray-900 mb-1">Verified employee</p>
