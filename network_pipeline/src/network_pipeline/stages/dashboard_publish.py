...
def run(
    ...
    *,
    ...
    people_nodes_path: str | Path | None = None,
    people_edges_path: str | Path | None = None,
    ...
    resolved_people_nodes_path = context.resolve_path(people_nodes_path) if people_nodes_path else None
    resolved_people_edges_path = context.resolve_path(people_edges_path) if people_edges_path else None
    ...
    if resolved_stage_path is not None:
        ...
        publish_root = publish_a16z_crypto_bundle(
            ...
            people_nodes_path=resolved_people_nodes_path,
            people_edges_path=resolved_people_edges_path,
        )
    else:
    ...
    return StageResult(
      ...
      outputs={
        ...
        "people_nodes_path": str(resolved_people_nodes_path) if resolved_people_nodes_path is not None else "",
        "people_edges_path": str(resolved_people_edges_path) if resolved_people_edges_path is not None else "",
